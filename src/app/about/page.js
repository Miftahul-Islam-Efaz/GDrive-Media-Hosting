...
export const metadata = {
  ...
  openGraph: {
    title: "Free Google Drive Media Hosting & Direct Link Generator",
    description: "Get direct image public URLs and free video hosting using your Google Drive as a public CDN.",
    type: "website"
  }
};
    ...
    <div style={{
      ...
      <div style={{
        ...
        <main>
          <section>
            <p style={{ fontSize: "1.1rem", lineHeight: 1.6, color: "#5f6368", marginBottom: 28 }}>
              GDrive Media Host is a state-of-the-art, client-side web application designed to turn your personal Google Drive account into a fast, reliable, and 100% free media hosting server. Generate direct public URLs for images, obtain copy-paste CDN hotlinks, and embed videos on your websites with absolute ease.
            </p>
          </section>

          <section style={{ margin: "40px 0" }}>
            <h2 style={{ fontSize: "1.5rem", fontWeight: 600, color: "#1f1f1f", marginBottom: 18, borderBottom: "2px solid #e9eef6", paddingBottom: 8 }}>
              Why Choose Google Drive Hosting?
            </h2>
            <div style={{ display: "grid", gridTemplateColumns: "1fr", gap: 20 }}>
              ...
              <div style={{ display: "flex", gap: 16 }}>
                ...
                <div>
                  <h3 style={{ fontSize: "1.05rem", fontWeight: 600, color: "#1f1f1f", marginBottom: 4 }}>Google Drive Image Upload & Hotlinking</h3>
              ...
              <div style={{ display: "flex", gap: 16 }}>
                ...
                <div>
                  ...
                  <p style={{ fontSize: "0.9rem", color: "#5f6368", lineHeight: 1.5 }}>
                    Store, manage, and play your video files inside your websites using Google Drive's native iframe preview player, completely bypassing bandwidth fees.
                  </p>
                </div>
              </div>
          ...
          <section style={{ margin: "40px 0" }}>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
              <div>
                <h4 style={{ fontSize: "1rem", fontWeight: 600, color: "#1f1f1f", marginBottom: 4 }}>How do I get an image public URL from Google Drive?</h4>
                <p style={{ fontSize: "0.9rem", color: "#5f6368", lineHeight: 1.5 }}>
                  Simply connect your Google Drive to this app, drag & drop an image, and click "Copy Link". The system handles authorization, folder permissions, and outputs a direct public URL ready to hotlink instantly.
                </p>
              </div>
              <div>
                <h4 style={{ fontSize: "1rem", fontWeight: 600, color: "#1f1f1f", marginBottom: 4 }}>Is there any bandwidth limit for free hosting?</h4>
                <p style={{ fontSize: "0.9rem", color: "#5f6368", lineHeight: 1.5 }}>
                  By hosting on Google Drive, you leverage Google's infrastructure. However, Drive imposes quota limits for rapid downloads, which is why images are optimized via caching, and video streaming requires native iframe embeds.
                </p>
              </div>
            </div>
          </section>
        ...
        <footer style={{ marginTop: 48, borderTop: "1px solid #dadce0", paddingTop: 24, textAlign: "center", fontSize: "0.8rem", color: "#80868b" }}>
          GDrive Media Host — The Premium Web Solution for Google Drive Image & Media Hosting.
        </footer>
